    ...
    <div class="row page_margin_top">
        <div class="column column_2_3">
            ...
            <ul class="list no_border indent spacing">
                <li class="bullet style_2"><a title="Home" href="home.html">Home Page</a></li>
                <li class="bullet style_2"><a title="Blog" href="blog.html">Blog</a></li>
                <li class="bullet style_2"><a title="Contact" href="contact.html">Contact</a></li>
            </ul>
        </div>
        <div class="column column_1_3">
            ...
            <div class="vertical_carousel_container clearfix">
                <ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
                    ...
                    <li class="post">
                        <a href="post_small_image.html" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">
                            <img src='images/samples/100x100/image_12.jpg' alt='img'>
                        </a>
                        <div class="post_content">
                            <h5>
                                <a href="post_small_image.html" title="Syrian Civilians Trapped For Months Continue To Be Evacuated">Syrian Civilians Trapped For Months Continue To Be Evacuated</a>
                            </h5>
                            <ul class="post_details simple">
                                <li class="category"><a href="category_world.html" title="WORLD">WORLD</a></li>
                                <li class="date">
                    ...
                    <li class="post">
                        <a href="post_quote_2.html" title="Nuclear Fusion Closer to Becoming a Reality">
                            <img src='images/samples/100x100/image_13.jpg' alt='img'>
                        </a>
                        <div class="post_content">
                            <h5>
                                <a href="post_quote_2.html" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a>
                            </h5>
                            <ul class="post_details simple">
                                <li class="category"><a href="category_science.html" title="SCIENCE">SCIENCE</a></li>
                                <li class="date">
