...
<div class="col-lg-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-9">
                    <form  action="/articles-admin-form/{{$article->article_id}}" method="post">
                        {!! csrf_field() !!}
                        {!! method_field('PUT') !!}
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="article_description" id="description" rows="20">{{$article->article_description}}</textarea>
