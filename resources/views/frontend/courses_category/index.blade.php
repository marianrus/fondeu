            ...
            <ul class="blog rating page_margin_top clearfix">
                ...
                <li class="post">
                    <div class="post_content">
                        ...
                        <h5><a href="post_quote_2.html" title="New Painkiller Rekindles Addiction Concerns">New Painkiller Rekindles Addiction Concerns</a></h5>
                        <ul class="post_details simple">
                            <li class="category"><a href="category_world.html" title="WORLD">WORLD</a></li>
                        </ul>
                    </div>
                ...
                <li class="post">
                    <div class="post_content">
                        ...
                        <h5><a href="post_small_image.html" title="Seeking the Right Chemistry, Drug Makers Hunt for Mergers">Seeking the Right Chemistry, Drug Makers Hunt for Mergers</a></h5>
                        <ul class="post_details simple">
                            <li class="category"><a href="category_sports.html" title="SPORTS">SPORTS</a></li>
                        </ul>
                    </div>
