        <div class="footer_container">
            ...
            <div class="row copyright_row">
                <div class="column column_2_3">
                    © Copyright <a href="http://quanticalabs.com" title="QuanticaLabs" target="_blank">QuanticaLabs</a> - PressRoom Template. <a href="http://themeforest.net/item/pressroom-responsive-news-and-magazine-template/9066845?ref=QuanticaLabs" title="PressRoom Template" target="_blank">Click here to buy it</a>
                </div>
                <div class="column column_1_3">
                    <ul class="footer_menu">
                        <li>
    ...
    </div> <!-- closing site_container-->

    <div class="background_overlay"></div>
        <!--js-->
        <script src="{{ URL::asset('js/Frontend/jquery-1.11.1.min.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery-migrate-1.2.1.min.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.ba-bbq.min.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery-ui-1.11.1.custom.min.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.easing.1.3.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.carouFredSel-6.2.1-packed.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.touchSwipe.min.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.transit.min.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.sliderControl.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.timeago.js') }}"></script>
        <script src="{{ URL::asset('js/Frontend/jquery.hint.js') }}"></script>
...
<!--        <script src="{{ URL::asset('plugins/datepicker/js/locales/bootstrap-datepicker.ro.js') }}"></script>-->
